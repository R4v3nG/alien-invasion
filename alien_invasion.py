...
class AlienInvasion:
    ...
    def _check_events(self):
        ...
        for i in pygame.event.get():
            if i.type == pygame.QUIT:
                ...
                self._check_keydown_events(i)

            elif i.type == pygame.KEYUP:
                self._check_keyup_events(i)
    ...
    def _check_keydown_events(self, i):
        if i.key == pygame.K_RIGHT:
            ...
            sys.exit()
        elif i.key == pygame.K_p and not self.stats.game_active:
            self.start_game()
            self.settings.initialize_dynamic_settings()
            self.sb.prep_score()
            self.sb.prep_level()
    ...
    def _change_fleet_direction(self):
        ...
        for i in self.aliens.sprites():
            i.rect.y += self.settings.fleet_drop_speed
    ...
    def _update_bullets(self):
        for i in self.bullets.copy():
            if i.rect.bottom <= 0:
            #if i.rect.right >= self.screen.get_rect().right:
    ...
    def _check_keyup_events(self, i):
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien.x = alien_width + 2 * alien_width * alien_number  # check it
